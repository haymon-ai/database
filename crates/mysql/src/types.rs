...
//!
//! `ListEntries` and the general `ListEntriesResponse` live in the shared
//! `dbmcp-server` crate; they are re-exported here so call sites can keep
//! importing them from `crate::types`.
